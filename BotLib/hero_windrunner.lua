...
local tAllAbilityBuildList = {
                        ...
                        {3,1,1,2,2,6,2,2,1,1,3,3,3,6,6},--pos4,5
}
...
if sRole == 'pos_3' then nAbilityBuildList = tAllAbilityBuildList[3] end
if sRole == 'pos_4' then nAbilityBuildList = tAllAbilityBuildList[4] end
if sRole == 'pos_5' then nAbilityBuildList = tAllAbilityBuildList[4] end
...
if sRole == 'pos_3' then nTalentBuildList = J.Skill.GetTalentBuild(tTalentTreeList[3]) end
if sRole == 'pos_4' then nTalentBuildList = J.Skill.GetTalentBuild(tTalentTreeList[4]) end
if sRole == 'pos_5' then nTalentBuildList = J.Skill.GetTalentBuild(tTalentTreeList[4]) end

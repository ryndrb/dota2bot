...
function X.SkillsComplement()
	...
	abilityQ = bot:GetAbilityByName('jakiro_dual_breath')
	abilityW = bot:GetAbilityByName('jakiro_ice_path')
	abilityE = bot:GetAbilityByName('jakiro_liquid_fire')
	abilityAS = bot:GetAbilityByName('jakiro_liquid_frost')
	abilityR = bot:GetAbilityByName('jakiro_macropyre')

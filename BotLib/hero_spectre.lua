...
function X.ConsiderDispersion()
    ...
    then
        if J.IsValidTarget(botTarget)
        then
            local nInRangeAlly = botTarget:GetNearbyHeroes(800, true, BOT_MODE_NONE)
    ...
    then
        ...
        do
            ...
            then
                ...
                and not GetUnitToLocationDistance(weakestTarget, GetAncient(GetOpposingTeam()):GetLocation()) < 200
                then

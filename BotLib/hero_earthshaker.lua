...
local tAllAbilityBuildList = {
                        {1,2,3,3,3,6,3,1,1,1,6,2,2,2,6},--pos2,3
...
function X.ConsiderEnchantTotem()
    ...
    then
        ...
        and J.GetManaAfter(EnchantTotem:GetManaCost()) > Fissure:GetManaCost()
        and J.GetManaAfter(EnchantTotem:GetManaCost()) > EchoSlam:GetManaCost()
        and J.IsAttacking(bot)
        then
            return BOT_ACTION_DESIRE_HIGH, 0, false
        end

...
X['spells'] = {
    ...
    ['invoker_quas'] = {weight = 1, hero = 'npc_dota_hero_invoker'},
    ['invoker_wex'] = {weight = 1, hero = 'npc_dota_hero_invoker'},
    ['invoker_exort'] = {weight = 1, hero = 'npc_dota_hero_invoker'},
    ['invoker_invoke'] = {weight = 1, hero = 'npc_dota_hero_invoker'},
    ['invoker_cold_snap'] = {weight = 0.5, hero = 'npc_dota_hero_invoker'},
    ['invoker_ghost_walk'] = {weight = 0.8, hero = 'npc_dota_hero_invoker'},
    ['invoker_tornado'] = {weight = 0.7, hero = 'npc_dota_hero_invoker'},
    ['invoker_emp'] = {weight = 0.4, hero = 'npc_dota_hero_invoker'},
    ['invoker_alacrity'] = {weight = 0.9, hero = 'npc_dota_hero_invoker'},
    ['invoker_chaos_meteor'] = {weight = 0.5, hero = 'npc_dota_hero_invoker'},
    ['invoker_sun_strike'] = {weight = 0.8, hero = 'npc_dota_hero_invoker'},
    ['invoker_forge_spirit'] = {weight = 0.9, hero = 'npc_dota_hero_invoker'},
    ['invoker_ice_wall'] = {weight = 0.7, hero = 'npc_dota_hero_invoker'},
    ['invoker_deafening_blast'] = {weight = 0.6, hero = 'npc_dota_hero_invoker'},

    ['jakiro_dual_breath'] = {weight = 0.8, hero = 'npc_dota_hero_jakiro'},
    ['jakiro_ice_path'] = {weight = 0.1, hero = 'npc_dota_hero_jakiro'},
    ['jakiro_liquid_fire'] = {weight = 1, hero = 'npc_dota_hero_jakiro'},
    ['jakiro_liquid_frost'] = {weight = 1, hero = 'npc_dota_hero_jakiro'},
    ['jakiro_macropyre'] = {weight = 0.1, hero = 'npc_dota_hero_jakiro'},

    ['juggernaut_blade_fury'] = {weight = 0.3, hero = 'npc_dota_hero_juggernaut'},
    ['juggernaut_healing_ward'] = {weight = 0.3, hero = 'npc_dota_hero_juggernaut'},
    ['juggernaut_blade_dance'] = {weight = 1, hero = 'npc_dota_hero_juggernaut'},
    ['juggernaut_swift_slash'] = {weight = 1, hero = 'npc_dota_hero_juggernaut'},
    ['juggernaut_omni_slash'] = {weight = 1, hero = 'npc_dota_hero_juggernaut'},

...
local Clockwerk = require(GetScriptDirectory()..'/FunLib/rubick_hero/Clockwerk')
...
local Dazzle = require(GetScriptDirectory()..'/FunLib/rubick_hero/dazzle')
...
function X.ConsiderStolenSpell(ability)
    ...
    DarkSeer.ConsiderStolenSpell(ability)
    Dawnbreaker.ConsiderStolenSpell(ability)
    Dazzle.ConsiderStolenSpell(ability)
    DeathProphet.ConsiderStolenSpell(ability)
    Disruptor.ConsiderStolenSpell(ability)
    Doom.ConsiderStolenSpell(ability)

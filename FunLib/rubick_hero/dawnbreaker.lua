...
function X.ConsiderStolenSpell(ability)
    ...
    if abilityName == 'dawnbreaker_celestial_hammer'
    then
        CelestialHammer = ability
    ...
    if abilityName == 'dawnbreaker_converge'
    then
        Converge = ability
    ...
    if abilityName == 'dawnbreaker_fire_wreath'
    then
        Starbreaker = ability
    ...
    if abilityName == 'dawnbreaker_solar_guardian'
    then
        SolarGuardian = ability
...
function X.ConsiderStarBreaker()
	...
	then
        ...
        and not X.IsTargetLocInBigUlt(nLocationAoE.targetloc)
        then
...
function X.ConsiderSolarGuardian()
    ...
    then
        ...
        then
            ...
            if  not X.IsTargetLocInBigUlt(nTeamFightLocation)
...
-- Helper Func
function X.IsTargetLocInBigUlt(loc)

...
function X.ConsiderStolenSpell(ability)
	...
	local _, spell = J.HasAbility(bot, 'ember_spirit_activate_fire_remnant')

    if abilityName == 'ember_spirit_sleight_of_fist'
    then
		SearingChains = ability
    ...
    if abilityName == 'ember_spirit_searing_chains'
    then
		SearingChains = ability
    ...
    if abilityName == 'ember_spirit_fire_remnant'
    then
		FireRemnant = ability
		ActivateFireRemnant = spell
    ...
    if abilityName == 'ember_spirit_activate_fire_remnant'
    then
		ActivateFireRemnant = ability
    ...
    if abilityName == 'ember_spirit_flame_guard'
    then
		FlameGuard = ability

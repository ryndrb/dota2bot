...
function X.ConsiderStolenSpell(ability)
    ...
    if abilityName == 'enigma_midnight_pulse'
    then
        MidnightPulse = ability
    ...
    if abilityName == 'enigma_malefice'
    then
        Malefice = ability
    ...
    if abilityName == 'enigma_demonic_conversion'
    then
        DemonicSummoning = ability

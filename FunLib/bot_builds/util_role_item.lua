...
Item['item_pipe'] = {
	...
	['npc_dota_hero_outworld_destroyer'] = true,
...
function X.GetBestUtilityItem(itemTable)
	...
	do
		...
		do
			...
			if Item['item_crimson_guard'][hName] and nItemList['item_crimson_guard']
			then
			...
			if Item['item_halberd'][hName] and nItemList['item_halberd']
			then
